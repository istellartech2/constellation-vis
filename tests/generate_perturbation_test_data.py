"""
Generate test data for perturbation calculations using poliastro.
...
def calculate_j2_j3_rates(a_km, e, i_deg, raan_deg, argp_deg, nu_deg):
    ...
    return {
        "j2": {
            "dOmega_dt_deg_per_day": j2_dOmega_dt * RAD_TO_DEG * SECONDS_PER_DAY,
            "domega_dt_deg_per_day": j2_domega_dt * RAD_TO_DEG * SECONDS_PER_DAY,
            "dM_dt_deg_per_day": j2_dM_dt * RAD_TO_DEG * SECONDS_PER_DAY,
        },
        "j3": {
...
for case in test_cases:
    ...
    test_data.append({
        ...
        "input": {
            ...
            "meanAnomalyDeg": case["nu_deg"],  # Using nu as M for simplicity
        },
        "expected": rates
    })
